...
Advantage-of-disadvantage is only an optimal choice when N=1 (you need to roll 1 or higher - not an interesting situation!). It's vacuous: all 3 choices give the same "odds". Otherwise, chose disadvantage-of-advantage for N up to 13, and choose single roll for N=14 and higher.
